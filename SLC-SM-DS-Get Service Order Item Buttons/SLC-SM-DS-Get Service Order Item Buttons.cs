...
namespace SLCSMDSGetServiceOrderItemButtons
{
	...
	public sealed class SLCSMDSGetServiceOrderItemButtons : IGQIDataSource
		, IGQIOnInit
		, IGQIInputArguments
	{
		...
		private List<ItemState> itemStateList = new List<ItemState> { ItemStates.newState, ItemStates.acknowledgedState, ItemStates.inprogressState, ItemStates.rejectState, ItemStates.failedState, ItemStates.partialState, ItemStates.heldState, ItemStates.pendingState, ItemStates.completedState, ItemStates.assesscancellationState, ItemStates.pendingcancellationState, ItemStates.cancelledState };
		...
		public GQIPage GetNextPage(GetNextPageInputArgs args)
		{
			...
			List<GQIRow> rows = activeButtons.Select(button => new GQIRow(new[] {
