namespace Skyline.DataMiner.ProjectApi.ServiceManagement.API.Configurations
{
	...
	public class DataHelperDiscreteParameterOptions : DataHelper<Models.DiscreteParameterOptions>
	{
		...
		/// <inheritdoc />
		public override bool TryDelete(IEnumerable<Models.DiscreteParameterOptions> items)
		{
			if (items == null)
			{
				return true;
		...
		/// <inheritdoc />
		internal override List<Models.DiscreteParameterOptions> Read(IEnumerable<DomInstance> domInstances)
		{
