namespace Skyline.DataMiner.ProjectApi.ServiceManagement.API.PeopleAndOrganization
{
	...
	public class DataHelperOrganization : DataHelper<Models.Organization>
	{
		...
		/// <inheritdoc />
		public override bool TryDelete(IEnumerable<Models.Organization> items)
		{
			if (items == null)
			{
				return true;
		...
		/// <inheritdoc />
		internal override List<Models.Organization> Read(IEnumerable<DomInstance> domInstances)
		{
