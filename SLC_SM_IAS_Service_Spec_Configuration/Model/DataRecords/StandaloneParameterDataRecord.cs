namespace SLC_SM_IAS_Service_Spec_Configuration.Model.DataRecords
{
	...
	public partial class ServiceConfigurationPresenter
	{
		internal sealed class StandaloneParameterDataRecord : IParameterDataRecord
		{
			...
			internal static StandaloneParameterDataRecord BuildDataRecord(Models.ServiceSpecificationConfigurationValue currentConfig, Skyline.DataMiner.ProjectApi.ServiceManagement.API.Configurations.Models.ConfigurationParameter configParam)
			{
