namespace Skyline.DataMiner.ProjectApi.ServiceManagement.API.ServiceManagement
{
	...
	public class DataHelperServiceOrderItem : DataHelper<Models.ServiceOrderItem>
	{
		...
		/// <inheritdoc />
		public override bool TryDelete(IEnumerable<Models.ServiceOrderItem> items)
		{
			if (items == null)
			{
				return true;
			...
			var helper = new DataHelperServiceOrderItemConfigurationValue(_connection);
		...
		/// <inheritdoc />
		internal override List<Models.ServiceOrderItem> Read(IEnumerable<DomInstance> domInstances)
		{
