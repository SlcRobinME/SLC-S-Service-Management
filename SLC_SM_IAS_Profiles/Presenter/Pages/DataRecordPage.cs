namespace SLC_SM_IAS_Profiles.Presenters
{
	...
	public sealed class ProfilePage : DataRecordPage
	{
		...
		public ProfileDataRecord ProfileDataRecord { get; set; }

		public void SetProfileDefinition(ProfileDataRecord profile)
		{
			ProfileDataRecord = profile;
		}

		public IEnumerable<Models.Profile> GetAncestors()
		{
			...
			while (page != null)
			{
				if (page is ProfilePage pp)
					yield return pp.ProfileDataRecord.Profile;
