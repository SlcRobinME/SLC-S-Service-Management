namespace Skyline.DataMiner.ProjectApi.ServiceManagement.API.Configurations
{
	...
	public class DataHelperDiscreteValues : DataHelper<Models.DiscreteValue>
	{
		...
		/// <inheritdoc />
		public override bool TryDelete(IEnumerable<Models.DiscreteValue> items)
		{
			if (items == null)
			{
				return true;
		...
		/// <inheritdoc />
		internal override List<Models.DiscreteValue> Read(IEnumerable<DomInstance> domInstances)
		{
