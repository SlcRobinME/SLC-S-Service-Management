namespace Skyline.DataMiner.ProjectApi.ServiceManagement.API.ServiceManagement
{
	...
	public class DataHelperServiceConfigurationValue : DataHelper<Models.ServiceConfigurationValue>
	{
		...
		/// <inheritdoc />
		public override bool TryDelete(IEnumerable<Models.ServiceConfigurationValue> items)
		{
			if (items == null)
			{
				return true;
		...
		internal override List<Models.ServiceConfigurationValue> Read(IEnumerable<DomInstance> domInstances)
		{
